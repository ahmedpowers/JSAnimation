...
h1{
font-family: "Bowlby One"; text-align:center; position:absolute; top:18%; font-weight:normal; color:#ff79ab; text-transform:uppercase; font-size:18px; transform: rotate(-45deg); opacity: 1;
}
...
.mybox2{top:200px;left:63%;}
.mybox3{top:200px;left:77%;}
.mybox4{top:300px;}
.mybox:hover, .mybox2:hover, .mybox3:hover, .mybox4:hover{border: 2px solid #d2d0d0;}
#main{background:url("creativeart7_slide1.jpg") center;}
</style>
...
<body>
  <div class = "close">
    ...
    <p style="font-size:20px; font-weight: bold; padding: 0 9px; margin: 0;"></p>
  </div>
  <div id = "main"  style = "width:1245px; float:left">
    <img src = "creativeart7_slide1.jpg"  width = "1245px" />
    <div class = "mybox"><h1 style = "top:22%; color:#ff911d">Adevertise Online</h1></div>
    <div class = "mybox2"><h1 style = "top:26%; color:#ff1c22">Create Websites</h1></div>
    <div class = "mybox3"><h1 style = "">Online Marketing</div>
    <div class = "mybox4"><h1 style = "top:20%; color:#3aa8f4">Business Branding</h1></div>
  </div>
</body>
...
var $x
$main.click(function(){
$(this).each(function (index, element){ //Opens Closed box clicked, closes open box
...
if (active == false){  //box click if all boxes are closed
$left = $(this).css('left')
$top = $(this).css('top')
